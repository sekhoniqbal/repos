<%@ Page Title="" Language="C#" MasterPageFile="~/Visitor/Visitor.master" AutoEventWireup="true" CodeFile="contactus.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  <div style="width:800px;margin-left:197px;margin-top:7px">
    ...
    <%Response.WriteFile("~//HTML Pages//contactus.htm"); %>
    </div>
</asp:Content>
