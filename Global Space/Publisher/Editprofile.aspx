<%@ Page Title="" Language="C#" MasterPageFile="~/Publisher/publisher.master" AutoEventWireup="true" CodeFile="Editprofile.aspx.cs" Inherits="Publisher_Default" Debug="true" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    
    
    <div id="outer" style="margin-left:50px">
    <table border="0" cellpadding="0" width="730px">
    <tr><td colspan="4">
    <div style="background-color:#598891; text-align:center;margin-left:5px; width:600px">
